#
#  Be sure to run `pod spec lint Debuddy.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author = "Ken Boucher"
  # s.authors            = { "ken" => "ken@kensfrequency.com" }
  ...
  s.source       = { :git => "https://github.com/KensFrequency/Debuddy.git", :tag => "#{s.version}" }
